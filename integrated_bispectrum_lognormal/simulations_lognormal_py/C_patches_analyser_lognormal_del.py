...
plt.title('$i\\zeta$ of Lognormal field - '+str(maps_count)+' maps with each map '+str(patch_count)+' patches ('+str(sq_degrees)+' sq. degrees each patch)')
plt.legend(fontsize=13)
plt.savefig(filepath+'plot_output/i_zeta_lognormal_'+str(maps_count)+'_maps_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.pdf')
