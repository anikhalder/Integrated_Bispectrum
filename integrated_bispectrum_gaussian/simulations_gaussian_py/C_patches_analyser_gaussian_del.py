...
for j in range(maps_count):
    ...
    for i in range(patch_count):
        ...
        mean_del = np.loadtxt(filepath_map+'B_treecorr_patches_correlated/correlation_gaussian_patch_'+str(i+1)+'.txt', usecols=(2))[0]
        ##var_del = np.loadtxt(filepath_map+'B_treecorr_patches_correlated/correlation_gaussian_patch_'+str(i+1)+'.txt', usecols=(3))[0]
        i_zeta_vec = np.loadtxt(filepath_map+'B_treecorr_patches_correlated/correlation_gaussian_patch_'+str(i+1)+'.txt', usecols=(4)) # i_zeta
...
dat = dat.T
np.savetxt(filepath+'plot_output/i_zeta_simulations_gaussian_'+str(maps_count)+'_maps_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', dat, delimiter = ' ')
