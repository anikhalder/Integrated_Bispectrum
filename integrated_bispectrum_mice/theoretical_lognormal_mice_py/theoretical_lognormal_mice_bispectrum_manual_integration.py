...
########################################################################
# Theoretical, simulated lognormal & mice i_zeta plot
########################################################################
theta_mean_mice_map_vec = np.loadtxt('../mice_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_mice_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(0)) # in arcmins
i_zeta_mean_mice_map_vec = np.loadtxt('../mice_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_mice_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(1))
i_zeta_std_dev_mice_map_vec = np.loadtxt('../mice_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_mice_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(2))
i_zeta_std_dev_mean_mice_map_vec = np.loadtxt('../mice_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_mice_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(3))
...
####################################
plt.figure(figsize=(10,10))
plt.scatter(theta_mean_mice_map_vec[1:], i_zeta_mean_mice_map_vec[1:]/i_zeta_vec[1:])
plt.xlim(1,200)
plt.ylim(0,5)
plt.xscale('log')
...
plt.savefig(str(sq_degrees)+'_sq_degrees/'+str(N)+'_pts/i_zeta_ratio_mice_theoretical_lognormal_patch_'+str(sq_degrees)+'_sq_degrees.pdf')
