...
####################################
theta_vec = np.loadtxt('../buzzard_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_jk_buzzard_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(0)) # in arcmins
i_zeta_mean_jk_all_maps_vec = np.loadtxt('../buzzard_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_jk_buzzard_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(1))
i_zeta_std_dev_jk_all_maps_vec = np.loadtxt('../buzzard_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_jk_buzzard_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(2))
i_zeta_std_dev_mean_jk_all_maps_vec = np.loadtxt('../buzzard_output/'+str(sq_degrees)+'_sq_degrees_'+str(patch_count)+'_patches/plot_output/i_zeta_jk_buzzard_map_'+str(patch_count)+'_patches_'+str(sq_degrees)+'_sq_degrees.txt', usecols=(3))

plt.figure(figsize=(10,10))
plt.plot(theta_scale_vec[1:], i_zeta_vec[1:], c='r', label='theoretical lognormal $i\\zeta(\\theta)$')
plt.errorbar(theta_vec[1:], i_zeta_mean_jk_all_maps_vec[1:], yerr=i_zeta_std_dev_jk_all_maps_vec[1:], marker=10, label='$i\\zeta$ - jacknife one map error')
...
plt.title('Integrated 3-pt function of lognormal field ('+str(sq_degrees)+' sq. degrees patch) \n # of evaluations = '+str(N)+'; $\\delta_0$ = '+str(log_shift), fontsize=14)
plt.legend(loc='best', fontsize=14)
plt.savefig(str(sq_degrees)+'_sq_degrees/'+str(N)+'_pts/i_zeta_jk_lognormal_theoretical_buzzard_patch_'+str(sq_degrees)+'_sq_degrees.pdf')

####################################
# Ratio plot
####################################
plt.figure(figsize=(10,10))
plt.scatter(theta_vec[1:], i_zeta_mean_jk_all_maps_vec[1:]/i_zeta_vec[1:])
plt.xlim(1,200)
plt.ylim(0,5)
plt.xscale('log')
...
plt.savefig(str(sq_degrees)+'_sq_degrees/'+str(N)+'_pts/i_zeta_jk_ratio_buzzard_theoretical_lognormal_patch_'+str(sq_degrees)+'_sq_degrees.pdf')
