...
## TreeCorr
# for auto-correlation of the buzzard density fluctuations
...
for i in range(patch_count):
    #print('Patch # '+str(i+1))
    density_fluctuations = hp.read_cl(filepath_map+'A_healpy_patches_produced/del_buzzard_patch_'+str(i+1)+'.fits')
    ...
    dat = dat.T
    np.savetxt(filepath_map+'B_treecorr_patches_correlated/correlation_buzzard_patch_'+str(i+1)+'.txt', dat, delimiter = ' ')
